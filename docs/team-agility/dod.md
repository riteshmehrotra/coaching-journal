...
|:----------------------------------------------------------|:----------------------------------------------------------|:----------------------------------------------------------|:-----------|
| :heavy_check_mark: All acceptance tests passed            | :heavy_check_mark: All acceptance tests passed            | :heavy_check_mark: All acceptance tests passed            | ....       |          
| :heavy_check_mark: Code peer reviewed / pair programmed   | :heavy_check_mark: Code peer reviewed / pair programmed   | :heavy_check_mark: Code peer reviewed / pair programmed   |            |
| :heavy_check_mark: Tested in Production clone environment | :heavy_check_mark: Security tests passed                  | :heavy_check_mark: Security tests passed                  |            |
| :heavy_check_mark: Functionality reviewed by business/PO  | :heavy_check_mark: Tested in Production clone environment | :heavy_check_mark: Tested in Production clone environment |            | 
|                                                           | :heavy_check_mark: Functionality reviewed by business/PO  | :heavy_check_mark: Functionality reviewed by business/PO  |            |
|                                                           | :heavy_check_mark: Documentation updated (as applicable)  | :heavy_check_mark: Documentation updated (as applicable)  |            |
|                                                           |                                                           | :heavy_check_mark: Deployed in Production                 | 
|                                                           |                                                           | :heavy_check_mark: Post deployment verification completed |            |
