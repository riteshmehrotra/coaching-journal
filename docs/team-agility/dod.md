...
|:----------------------------------------------------------|:--------------------------------------------------------|:-----------------------------------------------|:-----------|
| :white_check_mark: All acceptance tests passed            | :heavy_check_mark: All acceptance tests passed          | &check; All acceptance tests passed            | ....       |          
| :white_check_mark: Code peer reviewed / pair programmed   | :heavy_check_mark: Code peer reviewed / pair programmed | &check; Code peer reviewed / pair programmed   |            |
